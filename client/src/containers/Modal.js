            ...
            <div className="col-lg-6 col-md-12 col-sm-12 col-xs-12">
              <div className="quickview-content">
                ...
                <div className="add-to-cart">
                  ...
                  <a href="#0" className="btn min" aria-label="favourite"><i className="ti-heart" /></a>
                  <a href="#0" className="btn min" aria-label="favourite"><i className="fa fa-compress" /></a>
                </div>
                <div className="default-social">
                  <h4 className="share-now">Share:</h4>
                  <ul>
                    <li><a className="facebook" href="#0" aria-label="facebook"><i className="fa fa-facebook" /></a></li>
                    <li><a className="twitter" href="#0" aria-label="twitter"><i className="fa fa-twitter" /></a></li>
                    <li><a className="youtube" href="#0" aria-label="pinterest"><i className="fa fa-pinterest-p" /></a></li>
                    <li><a className="dribbble" href="#0" aria-label="google"><i className="fa fa-google-plus" /></a></li>
                  </ul>
                </div>
              </div>
            </div>
